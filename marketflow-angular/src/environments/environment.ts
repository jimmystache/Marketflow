// Environment configuration for MarketFlow
...
export const environment = {
  ...
  // Grok Cloud API configuration
  // Get your API key from: https://console.x.ai/
  grokApiUrl: 'https://api.groq.com/openai/v1/chat/completions',
  grokApiKey: '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' // Add your Grok API key here
};
